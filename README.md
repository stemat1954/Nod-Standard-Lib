...
12.  _imo_ is a common reference to a method's __implicit object__ (aka implicit method object, similar to _this_ or _self_ in other OO languages).  When followed by a dot (.), the reference refers to a sub-object in the implicit object.  Sub-objects are enumerated in a type's __instance__ definition.
